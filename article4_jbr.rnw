...
\citep{Helfat2007,Peteraf2013,Teece1997,Li2014,Jantunen201,Makkonen2014}. Dynamic
...
\begin{table}[t]
  ...
  variables.}
\label{tab:cor}
  <<corchild, child='/Users/larshovdanmolden/Documents/git/article4/figure/cortab.rnw',results="asis">>=
@
...
\label{tab:res}
  \scriptsize
  <<child-demo, child='/Users/larshovdanmolden/Documents/git/article4/figure/restab.rnw'>>=
@
   \begin{tablenotes}
      \tiny
...
%% regressor can be estimated consistently
 ...
 <<pathchild, child='/Users/larshovdanmolden/Documents/git/article4/figure/medanalysisall.rnw',results="asis">>=
@
...
leaving an important side of cognition \cite{Verona2011} and heuristics \cite{Arndt2015}
...
\newpage
  ...
  \begin{table}\label{tab:items}
    ...
    <<itemchild, child='/Users/larshovdanmolden/Documents/git/article4/figure/itemtab.rnw',results="asis">>=
    @
    \begin{tablenotes}
      \tiny
