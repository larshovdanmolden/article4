...
make sure incentives are aligned for change. 

Through the process of exploration, individuals in the organization may
...
interest, a shared cognitive frame emphasizing a growth mindset can be a useful
remedy. Furthermore, in addition to incentives alignment the more psychological element
of change buy-in comes into play \todo{Not sure how to proceed here - should we make a
  distinction between the incentive problem and the buy in problem? Coud they both be
  examples of interest alignment with different faces of motivation - extrensic vs intrinsic} (ref).   

To see how this would work recent contribution in neuroscience is helpful. Several
contributions have established a clear connection between having a growth mindset and
