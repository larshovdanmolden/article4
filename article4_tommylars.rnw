...
routines \citep{Winter2003,Eisenhardt2000}. However, very few, is any, papers attempts to
integrate varieties at multiple levels simultaneously. The bulk of contributions focus
